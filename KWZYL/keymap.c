...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_voyager(
    ...
    KC_TAB,         KC_Q,           KC_W,           KC_F,           KC_P,           KC_B,                                           KC_J,           KC_L,           KC_U,           KC_Y,           KC_QUOTE,       KC_TRANSPARENT, 
    KC_ESCAPE,      LT(6, KC_A),    MT(MOD_LGUI, KC_R),LT(3, KC_S),    MT(MOD_LCTL, KC_T),MT(MOD_LALT, KC_G),                                MT(MOD_RALT, KC_M),MT(MOD_RCTL, KC_N),LT(2, KC_E),    MT(MOD_RGUI, KC_I),LT(5, KC_O),    KC_TRANSPARENT, 
    CW_TOGG,        KC_Z,           KC_X,           KC_C,           KC_D,           KC_V,                                           KC_K,           KC_H,           ST_MACRO_0,     ST_MACRO_1,     KC_UNDS,        KC_TRANSPARENT, 
  ...
  [1] = LAYOUT_voyager(
    ...
    KC_NO,          KC_LBRC,        KC_LCBR,        KC_RCBR,        KC_RBRC,        KC_QUES,                                        KC_NO,          KC_GRAVE,       KC_DQUO,        KC_QUOTE,       KC_SPACE,       KC_NO,          
